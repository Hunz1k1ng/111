...
#ifndef VERILATED_VTINYRISCV_H_
#define VERILATED_VTINYRISCV_H_  // guard

#include "verilated_heavy.h"

class Vtinyriscv__Syms;
class Vtinyriscv___024root;
class VerilatedVcdC;
class Vtinyriscv_VerilatedVcd;


// This class is the main interface to the Verilated model
class Vtinyriscv VL_NOT_FINAL {
  private:
    // Symbol table holding complete model state (owned by this class)
    Vtinyriscv__Syms* const vlSymsp;
  ...
  public:
    ...
    Vtinyriscv___024root* const rootp;
    ...
    explicit Vtinyriscv(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vtinyriscv(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vtinyriscv();
  private:
    VL_UNCOPYABLE(Vtinyriscv);  ///< Copying not allowed
